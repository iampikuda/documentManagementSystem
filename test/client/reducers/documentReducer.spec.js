...
// import documents from '../../js/reducers/documents'
// import * as actions from '../../js/actions/documentManagement/';

// describe('Document Reducer', () => {
//   it.only('should add document when passed ADD_DOCUMENT', () => {
//     // arrange
//     const initialState = [
//       { title: 'A' },
//       { title: 'B' }
...
//     const action = { type: actionTypes.DOCUMENT_CREATED, document: newDocument };
